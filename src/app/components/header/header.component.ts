...
export class HeaderComponent implements AfterViewInit {
  ...
  public navList: NavigationList[] = [
    { name: 'Todo', link: '/mainpage/todo', icon: 'check_circle_outline'},
    { name: 'Documents', link: '#', icon: 'favorite_border' },
    { name: 'Parametres', link: '/mainpage/profile', icon: 'person_outline' }
  ];
